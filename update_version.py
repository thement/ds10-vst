...
def main():
  ...
  plistpath = scriptpath + "/resources/ds10-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ds10-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ds10-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ds10-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ds10-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ds10-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ds10-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ds10.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ds10.iss",inplace=1):
